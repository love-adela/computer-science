...
`char a[4] = {'a', 'b', 'c', '\0'};`
`char b[4] = "abc";` // 마지막 칸에는 \0으로 채워진다.
`char c[4] = "abcdef";` // 경고가 발생한다.
`char d[6] = "abc";` // a | b | c | \0 | \0
`char e[4] = "";`    // \0| \0| \0| \0
`char f[] = "abc";`  // char f[4] = "abc";와 같다.
...
char str2[4] = {'a', 'r', 'e', '\0'};
char str3[] = "the best";
printf("%s %s %s\n", str1, str2, str3); // "You are the best"
```
